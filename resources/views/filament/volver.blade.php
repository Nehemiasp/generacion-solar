...
@unless (request()->routeIs('filament.admin.pages.dashboard'))
    <a href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/admin') }}"
       ...
       class="fi-btn fi-btn-size-sm fi-btn-color-gray fi-color-gray inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-gray-950/10 hover:bg-gray-50 dark:text-gray-200 dark:ring-white/20 dark:hover:bg-white/5">
