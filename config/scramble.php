...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API pública de solo lectura del Sistema de Registro y Monitoreo de Generación Solar por Departamento (Guatemala). '
            .'Todos los recursos cuelgan de `/api/v1`; la raíz `/api/v1` devuelve un índice de endpoints. '
            .'Límite: 60 peticiones por minuto por IP. Los valores derivados (capacidad instalada, generación acumulada, CO₂ evitado) se calculan en cada petición.',
    ],

    'ui' => [
        'title' => 'Generación solar · API v1',
    ],
